...
import (
	...
	"errors"
	// Описания типов дял построения бинарных деревьев
	"go/ast"
	...
	// Конвертер строк
	"strconv"
	// Приведение имен константи к единому виду
	"strings"
	// // пакет для работы с ошибками
	// "erors"
	// // Описания типов дял построения бинарных деревьев
...
// Calculate рассчитывает данные выражения, переданного в сторке
func Calculate(expr string) (float64, error) {
	// Поиск управляющих операторов в строке и построение дерева
	// Вернет корневой элемент в переменную root все математические дйствия, построенные
	// в виде дерева
